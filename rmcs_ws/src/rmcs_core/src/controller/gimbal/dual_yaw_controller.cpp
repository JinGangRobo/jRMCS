...
public:
    DualYawController()
        ...
        register_input("/gimbal/bottom_yaw/estimated_velocity", estimated_bottom_yaw_velocity_);
        ...
        register_output("/debug/sliding_value", sliding_value_, nan_);
    }
    ...
    void update() override {
        ...
        double desired_top_vel =
            top_yaw_angle_pid_.update(filter::wrap_to_pi(*top_yaw_target_error_))
            + *top_yaw_target_velocity_;
        *top_yaw_control_torque_ =
            top_yaw_velocity_pid_.update(desired_top_vel - *gimbal_yaw_velocity_imu_);

        double e = filter::wrap_to_pi(*bottom_yaw_target_error_);
        double de = *bottom_yaw_target_velocity_ - *estimated_bottom_yaw_velocity_;
