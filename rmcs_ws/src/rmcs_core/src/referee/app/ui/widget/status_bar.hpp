...
public:
    StatusBar(double cool_limit, double bullet_limit)
        ...
        text_slash_of_bullet_.set_x(x_center - 20);
        text_slash_of_bullet_.set_y(y_center - 285);
        text_slash_of_bullet_.set_color(Shape::Color::WHITE);
        text_slash_of_bullet_.set_font_size(38);
        text_slash_of_bullet_.set_width(4);
        text_slash_of_bullet_.set_value("/");
    ...
    void set_visible(bool visible) {
        ...
        text_slash_of_bullet_.set_visible(visible);
